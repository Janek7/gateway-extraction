...
if __name__ == '__main__':
    full_vote = average_confidence_scores("data/results_relation_approaches/gateway_extraction/ge=standard_rc=goldstandard_vote=full/predictions.json")
    print(f"full_vote: {full_vote}")

    limited_vote = average_confidence_scores("data/results_relation_approaches/gateway_extraction/ge=standard_rc=goldstandard_vote=limited/predictions.json")
